...
class MrbAppBar(UserControl):
    def __init__(self, route):
        super().__init__()
        self.route = route

        # Criação do scheduler para atualização do horário
        ...
        self.app_barr = AppBar(
            ...
            actions=[
                ...
                Container(
                    ...
                    content=Column(
                        spacing=0,
                        controls=[Text("Bem vindo!", size=12), self.text_user],
                    ),
                ),
                self.btn_logout,
            ],
    ...
    def change_theme(self, e):
        ...
        elif self.route.page.theme_mode == ThemeMode.DARK:
